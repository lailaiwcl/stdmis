...
<body>
<form id="addStudentForm" action="<%=basePath%>studentmgr/add" method="post">
	<div id="addForm" style="padding:5px;">
	    ...
	    <table>
	       ...
	       <tr>
	           <td align="right" width="100px">学号：</td><td align="left"><input name="model.studentNo"  required="true" class="nui-textbox" /></td>
	       ...
	       <tr>
	           ...
	           <td align="right" width="100px">校区：</td><td align="left"><input name="model.schoolArea" vtype="rangeLength:1,20" class="nui-textbox" /></td>
	       </tr>
	       </table>				
	    ...
	    <table>
	       <tr width="100%">
	           ...
	           <td align="left" width="200px" rowspan="4"><img name="photoUrl" width="75px" height="100px" src="../upload/studentImages/default.jpg"  alt="学生照片" /></td>
	           <td align="left" rowspan="4">&nbsp;</td>
	       </tr>
	       <tr>
			...
			<table>
				<tr>
					<td style="text-align: right; padding-top: 5px; padding-right: 20px;" align="right">
						<a class="nui-button" iconCls="icon-add" style="width: 60px;" onclick="add()">添加</a>
    ...
    <script type="text/javascript">
        ...
        nui.parse();
        var form = new nui.Form("addStudentForm");
	    function add(){
        ...
        function onButtonEdit(e) {
            var btnEdit = this;
            nui.open({
                url:"<%=basePath%>jsp/classes/selectTreeClass.jsp",
                showMaxButton: false,
                title: "选择班级",
                width: 350,
                height: 350,
                ondestroy: function (action) {                    
                    if (action == "ok") {
                        ...
                        data = nui.clone(data);
                        if (data) {
                            btnEdit.setValue(data.classID);
                            btnEdit.setText(data.className);
                        }
                    }
                }
            });            
