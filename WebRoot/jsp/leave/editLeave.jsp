...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<input id="model.leaveID" name="model.leaveID" class="nui-hidden"/>
				<table style="width: 100%;">
					...
					<tr>
						...
						<td style="width: 300px;">
							<input id="model.startTime" allowInput="false" name="model.startTime" required="true" vtype="date:yyyy-MM-dd" class="nui-datepicker" ondrawdate="onStartDrawDate"/>
						</td>
					</tr>
					<tr>
						<td style="width: 80px;" align="right">结束时间：</td>
						<td style="width: 300px;">
							<input id="model.expiredTime" allowInput="false" name="model.expiredTime" required="true" vtype="date:yyyy-MM-dd" class="nui-datepicker" ondrawdate="onEndDrawDate"/>(不能超过30天)
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="width: 300px;">
						<br />
						 <a class="nui-button" iconCls="icon-upload" onclick="applyLeave()">修改</a>&nbsp;&nbsp;&nbsp;<a class="nui-button" iconCls="icon-cancel" onclick="cancel()">取消</a>	
 </td>
					</tr>
			</table>
		</form>
        ...
        function selectTeacher(){
             nui.open({
                url: "<%=basePath%>teacher/selectTeacher.jsp",
                showMaxButton: false,
                title: "选择审批人",
                width: 500,
                height: 380,
