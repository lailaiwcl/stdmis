nui.ux.MapWindow = function () {
    nui.ux.MapWindow.superclass.constructor.call(this);
    this.initControls();
}
nui.extend(nui.ux.MapWindow, nui.ux.Window, {
    title: "GMap Window",
...
nui.regClass(nui.ux.MapWindow, "ux.mapwindow");